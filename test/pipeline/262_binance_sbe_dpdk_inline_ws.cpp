...
// no separate WS process fork. 2 processes total (DPDK Poll + Transport+WS).
//
// Architecture:
//   - DPDK Poll Process (core 2): DPDK PMD → RAW_INBOX ring
...
// ============================================================================
// PipelineTraits for Binance SBE (DPDK InlineWS)
// ============================================================================
...
int main(int argc, char* argv[]) {
    if (argc < 2) {
        ...
        fprintf(stderr, "\nBinance SBE binary protocol test (DPDK InlineWS mode).\n");
    ...
    printf("==============================================\n");
    printf("  Binance SBE Test (DPDK InlineWS)            \n");
    printf("==============================================\n");
    printf("  Interface:  %s\n", interface);
    printf("  I/O:        DPDK PMD\n");
    ...
    pos += snprintf(summary + pos, sizeof(summary) - pos, "\n=== SBE InlineWS Test Results (DPDK) ===\n");
    ...
    pos += snprintf(summary + pos, sizeof(summary) - pos, "====================\n");
    pos += snprintf(summary + pos, sizeof(summary) - pos, "\n==============================================\n");
    pos += snprintf(summary + pos, sizeof(summary) - pos, "  SBE INLINE_WS TEST COMPLETE (DPDK)\n");
    pos += snprintf(summary + pos, sizeof(summary) - pos, "==============================================\n");
    ...
    {
        char path[256];
        snprintf(path, sizeof(path), "/tmp/sbe_dpdk_inline_ws_summary_%d.txt", getpid());
