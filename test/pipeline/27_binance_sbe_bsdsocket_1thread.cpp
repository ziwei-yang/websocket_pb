...
//
// Architecture:
//   - BSD Transport Process (1-thread: single-thread RX+TX loop) with SingleThreadSSL
...
// ============================================================================
// Pipeline Traits (1-thread SingleThreadSSL)
// ============================================================================

struct BinanceSBE1ThreadTraits : DefaultBSDPipelineConfig {
...
bool run_stream_test(BSDWebSocketPipeline<BinanceSBE1ThreadTraits>& pipeline) {
    ...
    dump_frame_records(frame_records.data(), frame_records.size(), "bsd_sbe_1t");

    char dump_path[256];
    snprintf(dump_path, sizeof(dump_path), "/tmp/bsd_sbe_1t_frame_records_%d.bin", getpid());
    ...
    write_summary("bsd_sbe_1t", actual_duration,
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  BSD Socket Binance SBE Test (1-thread)      \n");
    printf("==============================================\n");
    printf("  Target:     %s:%u (WSS)\n", BinanceSBE1ThreadTraits::WSS_HOST, BinanceSBE1ThreadTraits::WSS_PORT);
    printf("  Path:       %s\n", BinanceSBE1ThreadTraits::WSS_PATH);
    printf("  SSL:        %s\n", SSLPolicyType::name());
    printf("  Threading:  1-thread (SingleThreadSSL)\n");
    ...
    BSDWebSocketPipeline<BinanceSBE1ThreadTraits> pipeline;
    ...
    printf("\n==============================================\n");
    if (result == 0) {
        printf("  SBE TEST PASSED (1-thread)\n");
    } else {
        printf("  SBE TEST FAILED (1-thread)\n");
    }
    printf("==============================================\n");
