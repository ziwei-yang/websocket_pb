// test/pipeline/22_websocket_binance_bsdsocket_2thread.cpp
// BSD Socket WebSocket Binance Test - 2-thread InlineSSL mode
//
...
//
// Usage:
//   make build-test-pipeline-websocket_binance_bsdsocket_2thread NIC_MTU=1500 USE_OPENSSL=1
//   make test-pipeline-websocket-binance-bsdsocket-2thread NIC_MTU=1500 USE_OPENSSL=1
//
// Options:
...
struct BinanceBSD2ThreadTraits : DefaultBSDPipelineConfig {
...
bool run_stream_test(BSDWebSocketPipeline<BinanceBSD2ThreadTraits>& pipeline) {
...
int main(int argc, char* argv[]) {
    ...
    printf("==============================================\n");
    printf("  BSD Socket WebSocket Binance Test (2-thread)\n");
    printf("==============================================\n");
    printf("  Target:     %s:%u (WSS)\n", BinanceBSD2ThreadTraits::WSS_HOST, BinanceBSD2ThreadTraits::WSS_PORT);
    printf("  Path:       %s\n", BinanceBSD2ThreadTraits::WSS_PATH);
    printf("  SSL:        %s\n", SSLPolicyType::name());
    ...
    BSDWebSocketPipeline<BinanceBSD2ThreadTraits> pipeline;
